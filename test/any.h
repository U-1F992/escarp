...
typedef struct test_case_any_parse_t {
    escarp_uint8_t *in;
    size_t in_idx;
    size_t in_len;
...
} test_case_any_parse_t;

static size_t test_any_parse(void) {
    size_t test_failure = 0;

    escarp_uint8_t in_0[] = {0};
    escarp_uint8_t expected_out_0[] = {0};
    escarp_uint8_t in_1[] = {128};
    escarp_uint8_t expected_out_1[] = {128};
    escarp_uint8_t in_2[] = {255};
    escarp_uint8_t expected_out_2[] = {255};
    escarp_uint8_t in_3[] = {0, 1};
    escarp_uint8_t expected_out_3[] = {1};
    escarp_uint8_t in_4[] = {0, 1};
    test_case_any_parse_t test_case[] = {
        {in_0, 0, sizeof(in_0), ESCARP_SUCCESS, 1, expected_out_0,
         sizeof(expected_out_0)},
        {in_1, 0, sizeof(in_1), ESCARP_SUCCESS, 1, expected_out_1,
         sizeof(expected_out_1)},
        {in_2, 0, sizeof(in_2), ESCARP_SUCCESS, 1, expected_out_2,
         sizeof(expected_out_2)},
        {in_3, 1, sizeof(in_3), ESCARP_SUCCESS, 2, expected_out_3,
         sizeof(expected_out_3)},
        {in_3, 2, sizeof(in_4), ESCARP_PARSER_ERROR_UNEXPECTED_EOF}};
    size_t test_case_len = sizeof(test_case) / sizeof(test_case_any_parse_t);
    size_t i = 0;

    printf("* %s\n", __func__);

    for (i = 0; i < test_case_len; i++) {
        escarp_parser_t *parser = escarp_any();
